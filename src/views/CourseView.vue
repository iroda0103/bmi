    ...
    <div v-else-if="course" class="course-content-wrapper">
      ...
      <div class="course-lessons-sidebar">
        ...
        <div class="lessons-list">
          <div v-for="(lesson, index) in courseLessons" :key="lesson.id" class="lesson-item"
            :class="{ 'active': currentLessonId === lesson.id }" @click="selectLesson(lesson)">
            <div class="lesson-number">{{ index + 1 }}</div>
            <div class="lesson-info">
              <h4 class="lesson-title">{{ lesson.title }}</h4>
              <div class="lesson-meta">
                <span class="lesson-duration">{{ lesson.duration }}</span>
                <span  v-if="token" class="lesson-status" :class="lesson.status">{{ lesson.statusText }}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  data() {
    return {
      ...
      localLessons: [
        {
          id: 1,
          title: "JavaScript asoslari va sintaksisi",
          duration: "45 daqiqa",
          status: "completed",
          statusText: "Tugatilgan",
          description: "JavaScript sintaksisi, o'zgaruvchilar (var, let, const), ma'lumot turlari, operatorlar va funksiyalar asoslarini o‘rganish."
        },
        {
          id: 2,
          title: "Massivlar va obyektlar bilan ishlash",
          duration: "1 soat",
          status: "completed",
          statusText: "Tugatilgan",
          description: "Massiv va obyektlar yaratish, ularni o‘zgartirish, metodlar (push, pop, map, filter, reduce) va asosiy foydalanish."
        },
        {
          id: 3,
          title: "Funksiyalar, Scope va Closures",
          duration: "1 soat 10 daqiqa",
          status: "in-progress",
          statusText: "Davom etmoqda",
          description: "Deklaratsiya va ifoda funksiyalari, lexical scope, closures tushunchasi va real hayotdagi misollar bilan ishlash."
        },
        {
          id: 4,
          title: "Rekursiya va rekursiv funksiyalar",
          duration: "1 soat 20 daqiqa",
          status: "locked",
          statusText: "Qulflangan",
          description: "Rekursiv funksiyalar, stack overflow, iterativ alternativalar, klassik misollar: Fibonacci, faktorial, binary search."
        },
        {
          id: 5,
          title: "Sortlash algoritmlari",
          duration: "1 soat 15 daqiqa",
          status: "locked",
          statusText: "Qulflangan",
          description: "Bubble sort, selection sort, insertion sort, merge sort va quicksort algoritmlarini JavaScriptda yozish va tahlil qilish."
        },
        {
          id: 6,
          ...
          status: "locked",
          statusText: "Qulflangan",
          description: "Line search, binary search, va JavaScript Map, Set strukturalarida qidiruvlar amalga oshirish."
        },
        {
          id: 7,
          ...
          status: "locked",
          statusText: "Qulflangan",
          description: "Stack, Queue, Linked List, Tree va Graph asoslari. Ularni JavaScriptda qo‘lda yaratish va amaliyotda ishlatish."
        },
        {
          id: 8,
          title: "Graph algoritmlari: BFS va DFS",
          duration: "1 soat 40 daqiqa",
          status: "locked",
          statusText: "Qulflangan",
          description: "Graphni ifodalash (adjacency list), kenglik va chuqurlik bo‘yicha qidiruv (BFS/DFS) algoritmlarini amalga oshirish."
        },
        {
          id: 9,
          title: "Dinamik dasturlashga kirish",
          duration: "1 soat 45 daqiqa",
          status: "locked",
          statusText: "Qulflangan",
          description: "Subproblemalar, optimal substructure, memoization va tabulation. Fibonacci, LCS va boshqa misollar."
        },
        {
          id: 10,
          title: "Amaliy loyiha: Algoritmik masalalar yechish",
          duration: "2 soat",
          status: "locked",
          statusText: "Qulflangan",
          description: "LeetCode, HackerRank kabi platformalardagi JavaScript masalalarni yechish. Strategiyalar va real dunyo muammolari."
        }
      ]
  ...
  methods: {
    ...
    selectLesson(lesson) {
      if (lesson.status === 'locked') {
        alert('Bu dars qulflangan. Iltimos, avvalgi darslarni tugating.');
        return;
      }
      else {
        this.$router.push({ path: `/course/${this.course.id}/lesson/${lesson.id}` });
